...
Перейдите на [страницу релизов](https://github.com/alttux/tg-ws-proxy/releases) и скачайте **`TgWsProxy.app.zip`**.
...
> **Примечание про нативный клиент для MacOS:** с нативным клиентом использовать приложение не рекомендуется. Лучше используйте Telegram Lite.
